...
{
    // Don't do the following at home. pragma inserted to avoid a specific deprecated warning. Deprecated functions should always be changed.
    #pragma GCC diagnostic push
